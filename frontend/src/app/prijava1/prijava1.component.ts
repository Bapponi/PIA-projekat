...
@Component({
  selector: 'app-prijava1',
  templateUrl: './prijava1.component.html',
  styleUrls: ['./prijava1.component.css']
})
export class Prijava1Component implements OnInit {
    ...
    subscribe((korisnik: Korisnik)=>{
      ...
      if(korisnik){
        ...
        if(korisnik.tip == "citalac"){
          ...
          this.greska = 'Ne možete se ulogovati kao admin!'
          // console.log("admin");
          // this.app.korisnik = korisnik;
          // this.ruter.navigate(['']);
          // this.meni.ngOnInit();
